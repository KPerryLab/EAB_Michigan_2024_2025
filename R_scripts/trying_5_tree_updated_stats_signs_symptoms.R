...
sum(ash_by_plot$number_trees > 5, na.rm=TRUE) # There are 13 plots where total 
# number of trees is greater than 5
...
# This sub-setting reduces the sample size to 305 trees
